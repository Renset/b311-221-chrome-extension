$(function () {
    ...
    var postAjax = function(endpoint,data,token) {
        return $.ajax({
            type: "POST",    
            url: endpoint,
            headers: {
    ...
    var getStatus = function() {
      var endpoint = api+"device/signal";
      return getAjax(endpoint);
    }

    var getAntennaStatus = function() {
      var endpoint = api+"device/antenna_type";
      return getAjax(endpoint);
    }

    var getAntennaSetType = function() {
      var endpoint = api+"device/antenna_set_type";
      return getAjax(endpoint);
    }

    var getToken = function() {
      var endpoint = api+"webserver/token";
      return getAjax(endpoint);
    }
    ...
    var getLoginStatus = function(){
        var endpoint = api+"user/heartbeat";
        return getAjax(endpoint);
    }
    ...
    function processSignalStatus(){
        getStatus().success(function(resp) {
                ...
                var dlbandwidth = getXML(resp,'dlbandwidth'); 
